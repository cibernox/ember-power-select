...
export default class PowerSelectOptionsComponent<T = unknown, TExtra = unknown, IsMultiple extends boolean = false> extends Component<PowerSelectOptionsSignature<T, TExtra, IsMultiple>> {
