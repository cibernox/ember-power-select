...
export default class PowerSelectBeforeOptionsComponent<T = unknown, TExtra = unknown, IsMultiple extends boolean = false> extends Component<PowerSelectBeforeOptionsSignature<T, TExtra, IsMultiple>> {
    didSetup: boolean;
