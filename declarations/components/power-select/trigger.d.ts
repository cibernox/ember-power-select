...
export default class PowerSelectTrigger<T = unknown, TExtra = unknown, IsMultiple extends boolean = false> extends Component<PowerSelectTriggerSignature<T, TExtra, IsMultiple>> {
    private _lastIsOpen;
