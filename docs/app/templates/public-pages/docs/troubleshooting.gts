...
<template>
  ...
  <p>
    ...
    Modals usually have higher z-indexes (bootstrap itself uses 1050) because if a
    modal opens unexpectedly while ember-power-select is open, you don't want the
    list of options to be placed on top.
  </p>

  <p>
    However if you want to render a select inside a modal, that is a situation you
    can predict and design for. There is two possible solutions:
  </p>
  ...
  <ol>
    <li>
      ...
      have the class
      <code>"in-modal-dropdown"</code>. You can increase the z-index of this kind
      of selects.
    </li>
    <br />
    <li>
      ...
      therefore it won't be afected by this z-index issue. Keep in mind that when
      rendered in place the list of options will loose its ability to
      intelligently position itself above the component if the space below is too
      small to fit it.
    </li>
  </ol>
