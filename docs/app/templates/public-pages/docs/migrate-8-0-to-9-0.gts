...
<template>
  ...
  <p>
    The highlight of version 9.x is that the addon is now fully typed with
    TypeScript.<br />
    All remaining
    <code>any</code>
    types have been removed, reducing runtime issues and improving developer
    experience for anyone using TypeScript or
    <a
    ...
    as most of the breaking changes were introduced in 8.x.
  </p>
  ...
  <ul>
    ...
    <li>
      <p>
        TypeScript: All remaining
        <code>any</code>
        types have been removed.<br />
        <small>Depending on the correctness of your app, this might require a
          significant amount of work. To avoid major disruption during the 8.x
          cycle, this change has been introduced in 9.x. For a better
          understanding of correct typing, see the TypeScript section.</small>
      </p>
    </li>
    <li>
      <p>
        TypeScript types that were not part of the component have been moved to
        <code>types.ts</code>.
      </p>
    </li>
    <li>
