...
<template>
  ...
  <p>
    ...
    <code>select</code>
    tag but it is very limited. They can only display plain text, they look
    totally different in each browser and you can't reliably style them, so devs
    have built their own select components to bypass all these limitations.
  </p>
  ...
  <p>
    ...
    and
    <a href="https://select2.github.io/">Select2</a>, that solve the styling
    issues while allowing features that the original tag can't have.
  </p>
  ...
  <p>
    ...
    and
    <a
      href="https://github.com/miguelcobain/ember-cli-selectize"
    >ember-cli-selectize</a>), involves a significant amount of glue code and
    prevents us from taking advantage of Ember's primitives.
  </p>

  <p>
    This project aims to build a select component that has all the features of
    those existing libraries but allows to you to leverage Ember's primitives.
  </p>
