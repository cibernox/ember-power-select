  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>When truthy, the select field is a multiple select field</td>
      </tr>
      <tr>
        <td>afterOptionsComponent</td>
        <td><code>contextual-component</code></td>
        <td>The component rendered after the list of options. It is empty by
          default in both single and multiple selects</td>
      </tr>
      <tr>
        <td>allowClear</td>
        <td><code>boolean</code></td>
      ...
      <tr>
        ...
        <td>Adds a
          <code>&lt;label&gt;</code>
          for the select field. The benefit to use this is, that
          <code>aria-*</code>
          attributes are already automatically correct like defined by
          <a
      ...
      <tr>
        ...
        <td><code>string</code></td>
        <td>Action which should be happen by clicking on label. Possible values:
          'focus' or 'open'. Default is focus</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><code>contextual-component</code></td>
        <td>The component rendered before the list of options. In single selects
          defaults to the searchbox. In multiple select defaults to nothing</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><code>Function</code></td>
        <td>
          A function that allows to customize the position and dimension of the
          select's content. For more info check
          https://www.ember-basic-dropdown.com/docs/position
        </td>
      </tr>
      <tr>
        <td>class</td>
      ...
      <tr>
        ...
        <td>
          The id of the element used as target for the content of the dropdown,
      ...
      <tr>
        ...
        <td>
          ...
          <code>"auto"</code>, meaning that will position the list depending on
          the side of the trigger. Possible values are
          <code>"left"</code>,
          <code>"center"</code>
          and
          <code>"right"</code>.
      ...
      <tr>
        ...
        <td><code>string</code></td>
        <td>
          Message shown in the list of options while the options are still not
          resolved, typically after a search but also when
          <code>options</code>
          is a promise.
        </td>
      </tr>
      <tr>
        ...
        <td>
          Defaults to
          <code>"mousedown"</code>. Indicates the type of event the trigger
          component will be listening to open or close.
        </td>
      </tr>
      <tr>
        <td>rootEventType</td>
      ...
      <tr>
        ...
        <td>
          When enabled (and it's enabled by default) the dropdown with match the
      ...
      <tr>
        ...
        <td><code>contextual-component</code></td>
        <td>The component to render instead of the default one around the no
          matches message.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td>onChange</td>
        <td><code>function</code></td>
        <td>The function to be invoked when the user selects or unselects an
          option</td>
      </tr>
      <tr>
        <td>onClose</td>
      ...
      <tr>
        <td>onKeydown</td>
        <td><code>function</code></td>
        <td>The function to be invoked when the user presses a key being the
          component or the inputs inside it focused</td>
      </tr>
      <tr>
        <td>onOpen</td>
        <td><code>function</code></td>
      ...
      <tr>
        <td>registerAPI</td>
        <td><code>function</code></td>
        <td>The function that will be called when the component is instantiated
          and also when any state changes inside the component, and receives a
          publicAPI object that the user can use to control the select from the
          outside using the actions in it.</td>
      </tr>
      <tr>
        <td>options</td>
      ...
      <tr>
        <td>placeholder</td>
        <td><code>string</code></td>
        <td>Text to display in the trigger of the component while no option is
          selected</td>
      </tr>
      <tr>
        <td>placeholderComponent</td>
        <td><code>contextual-component</code></td>
        <td>Component to be rendered as placeholder. It can be used along with
          <code>placeholder</code>
          and has access to it</td>
      </tr>
      <tr>
        <td>preventScroll</td>
      ...
      <tr>
        ...
        <td><code>function</code></td>
        <td>The
          <code>function(searchTerm)</code>
          to invoke when the user uses the search input.</td>
      </tr>
      <tr>
        <td>searchEnabled</td>
        <td><code>boolean</code></td>
      ...
      <tr>
        <td>searchField</td>
        <td><code>string</code></td>
        <td>When the options are objects and no custom matches function is
          provided, this option tells the component what property of the options
          should the default matches use to filter</td>
      </tr>
      <tr>
        <td>searchFieldPosition</td>
        <td><code>string</code></td>
        <td>Allows to change the position of search field. Possible values:
          'before-options' or 'trigger'. Default is single is before-options,
          default for multiple is trigger</td>
      </tr>
      <tr>
        <td>searchMessage</td>
        <td><code>string</code></td>
        <td>Message shown in options list when no search has been entered and
          there are no options.</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><code>contextual-component</code></td>
        <td>The component to render to customize just the selected item of the
          trigger</td>
      </tr>
      <tr>
        <td>tabindex</td>
      ...
      <tr>
        <td>triggerId</td>
        <td><code>string</code></td>
        <td>The id to be applied to the trigger. Useful link the select to a
          <code>&lt;label&gt;</code>
          tag</td>
      </tr>
      <tr>
        <td>triggerRole</td>
        <td><code>string</code></td>
        <td>The aria-role to use on the trigger element. Defaults to
          <code>'button'</code></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          ...
          <code>"auto"</code>, meaning that will position the list depending on
          the space available around the trigger. The other possible values are
          <code>"above"</code>
          and
          <code>"below"</code>.
        </td>
