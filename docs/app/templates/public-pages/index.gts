  ...
  <section class="selling-points">
    <article class="selling-point">
      ...
      <div class="selling-point-text">
        ...
        filtering, multiple selections, keyboard navigation and is accesible
        right away.
      </div>
    </article>
    ...
    <article class="selling-point">
      ...
      <div class="selling-point-text">
        ...
        Built using ember best practices, it feels natural to use and plays
        nicely with promises, actions, and ember-data collections.
      </div>
    </article>
    ...
    <article class="selling-point">
      ...
      <div class="selling-point-text">
        ...
        Something totally custom? Just replace pieces of the select with your
        own components and do it.
      </div>
    </article>
  </section>
