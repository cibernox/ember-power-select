    ...
    <section class="selling-points">
      ...
      <article class="selling-point">
        ...
        <div class="selling-point-text">
          ...
          Built using ember best practices, it feels natural to use and plays nicely
          with promises, actions, and ember-data collections.
        </div>
      </article>
