...
module(
  ...
  function (hooks) {
    ...
    test('The default label is rendered as a label element when @labelTag is not provided', async function (assert) {
      assert.expect(1);
    ...
    test('The labelTag="span" renders a span element instead of a label element for better accessibility', async function (assert) {
      assert.expect(1);
