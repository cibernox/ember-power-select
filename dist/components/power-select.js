...
class PowerSelect extends Component {
  ...
  get selected() {
    if (emberPowerSelectIsSelectedPresent(this._resolvedSelected)) {
      return toPlainArray(this._resolvedSelected);
    } else if (emberPowerSelectIsSelectedPresent(this.args.selected) && !isPromiseLike(this.args.selected)) {
  ...
  __updateSelected() {
    if (!emberPowerSelectIsSelectedPresent(this.args.selected)) return;
