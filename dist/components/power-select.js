...
class PowerSelectComponent extends Component {
  ...
  #_resolvedOptions = (i(this, "_resolvedOptions"), undefined);
  static {
    g(this.prototype, "_resolvedSelected", [tracked]);
  }
  #_resolvedSelected = (i(this, "_resolvedSelected"), undefined);
  static {
    g(this.prototype, "_repeatingChar", [tracked], function () {
      return '';
    });
  }
  #_repeatingChar = (i(this, "_repeatingChar"), undefined);
  static {
    g(this.prototype, "_expirableSearchText", [tracked], function () {
      return '';
    });
  }
  #_expirableSearchText = (i(this, "_expirableSearchText"), undefined);
  static {
    g(this.prototype, "_searchResult", [tracked]);
  }
  #_searchResult = (i(this, "_searchResult"), undefined);
  static {
    g(this.prototype, "isActive", [tracked], function () {
      return false;
    });
  }
  #isActive = (i(this, "isActive"), undefined);
  static {
    g(this.prototype, "loading", [tracked], function () {
      return false;
    });
  }
  #loading = (i(this, "loading"), undefined);
  static {
    g(this.prototype, "searchText", [tracked], function () {
      return '';
    });
  }
  #searchText = (i(this, "searchText"), undefined);
  static {
    g(this.prototype, "lastSearchedText", [tracked], function () {
      return '';
    });
  }
  #lastSearchedText = (i(this, "lastSearchedText"), undefined);
  static {
    g(this.prototype, "highlighted", [tracked]);
  }
  #highlighted = (i(this, "highlighted"), undefined);
  storedAPI;
  _uid = guidFor(this);
  _lastOptionsPromise;
