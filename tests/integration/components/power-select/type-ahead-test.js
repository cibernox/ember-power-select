...
import { optionAtIndex } from "@salsify/ember-power-select/utils/group-utils";
...
module(
  ...
  function(hooks) {
    ...
    [["Closed", WITH_EPS_CLOSED], ["Open", WITH_EPS_OPEN]].forEach(
      ([state, helpers]) => {
      ...
      `);
          ...
          let trigger = this.element.querySelector(
