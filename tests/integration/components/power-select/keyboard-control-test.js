...
module(
  ...
  function (hooks) {
    ...
    test('Pressing ENTER selects the highlighted element, closes the dropdown and focuses the trigger', async function (assert) {
      ...
      await render(hbs`
      <PowerSelect @options={{this.numbers}} @selected={{this.selected}} @onChange={{fn this.changed}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelect>
    `);
    ...
    test('Pressing ENTER when there is no highlighted element, closes the dropdown and focuses the trigger without calling the onchange function', async function (assert) {
      ...
      await render(hbs`
      <PowerSelect @options={{this.numbers}} @selected={{this.selected}} @onChange={{fn this.handleChange}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelect>
    `);
    ...
    test('Pressing SPACE on a select without a searchbox selects the highlighted element, closes the dropdown and focuses the trigger without scrolling the page', async function (assert) {
      ...
      await render(hbs`
      <PowerSelect @options={{this.numbers}} @selected={{this.selected}} @onChange={{fn this.changed}} as |option|>
        {{option}}
      </PowerSelect>
    `);
    ...
    test('In single-mode, when the user presses SPACE on the searchbox, the highlighted option is not selected, and that space is part of the search', async function (assert) {
      ...
      await render(hbs`
      <PowerSelect @options={{this.numbers}} @selected={{this.selected}} @onChange={{fn (mut this.foo)}} @onKeydown={{fn this.handleKeydown}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelect>
    `);
    ...
    test('In multiple-mode, when the user presses SPACE on the searchbox, the highlighted option is not selected, and that space is part of the search', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.selected}} @onChange={{fn (mut this.foo)}} @onKeydown={{fn this.handleKeydown}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
    ...
    test('In multiple-mode, when the user presses a key being the search input focused the passes `@onKeydown` action is invoked with the public API and the event', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.selectedNumbers}} @onChange={{fn (mut this.foo)}} @onKeydown={{fn this.handleKeydown}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
    ...
    test('BUGFIX: If pressing up/down arrow on a single select DOES NOT the dropdown, the event is defaultPrevented', async function (assert) {
      ...
      await render(hbs`
      <PowerSelect @options={{this.numbers}} @onChange={{fn (mut this.foo)}} @onOpen={{fn this.handleOpen}} as |option|>
        {{option}}
      </PowerSelect>
    `);
    ...
    test('BUGFIX: If pressing up/down arrow on a multiple select opens the select, the event is defaultPrevented', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @onChange={{fn (mut this.foo)}} @onOpen={{fn this.handleOpen}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
