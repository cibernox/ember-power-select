...
module('Integration | Component | Ember Power Select (Multiple)', function(hooks) {
  ...
  test('Selecting an element triggers the onchange action with the list of selected options', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @onChange={{change}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('Click an option when there is already another selects both, and triggers the onchange action with them', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{selectedNumbers}} @onChange={{change}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('If there is many selections, all those options are styled as `selected`', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{selectedNumbers}} @onChange={{action (mut selectedNumbers)}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('The default filtering works in multiple mode', async function(assert) {
    ...
    this.numbers = numbers;
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @onChange={{action (mut this.foo)}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('The filtering specifying a searchkey works in multiple model', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{people}} @searchField="name" @onChange={{action (mut this.foo)}} @searchEnabled={{true}} as |person|>
  ...
  test('The filtering specifying a custom matcher works in multiple model', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @matcher={{endsWithMatcher}} @onChange={{action (mut this.foo)}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('The search using a custom action works int multiple mode', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @search={{searchFn}} @onChange={{action (mut this.foo)}} @searchEnabled={{true}} as |number|>
        {{number}}
      </PowerSelectMultiple>
    `);
  ...
  test('Pressing ENTER over a highlighted element selects it', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{change}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('Pressing ENTER over a highlighted element on a select without a searchbox selects it', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{change}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('Pressing ENTER over a highlighted element what is already selected closes the select without doing anything and focuses the trigger', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.selected}} @onChange={{didChange}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('Pressing BACKSPACE on the search input when it\'s empty removes the last selection and performs a search for that text immediately, opening the select if closed', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @onChange={{didChange}} @selected={{this.selected}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('The placeholder is only visible when no options are selected', async function(assert) {
    ...
    this.numbers = numbers;
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{action (mut this.foo)}} @placeholder="Select stuff here" @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('The placeholder is visible when no options are selected and search is disabled', async function(assert) {
    ...
    this.numbers = numbers;
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{action (mut this.foo)}} @placeholder="Select stuff here" as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('Typing in the input opens the component and filters the options also with async searches', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @selected={{this.foo}} @onChange={{action (mut this.foo)}} @search={{action search}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('The publicAPI is yielded as second argument in multiple selects', async function(assert) {
    ...
    this.numbers = numbers;
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{action (mut this.foo)}} @searchEnabled={{true}} as |option select|>
  ...
  test('When hitting ENTER after a search with no results, the component is closed but the onchange function is not invoked', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{action handleChange}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('The trigger of multiple selects have a special class to distinguish them from regular ones, even if you pass them another one', async function(assert) {
    ...
    this.numbers = numbers;
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @triggerClass="foobar-trigger" @selected={{this.foo}} @onChange={{action (mut this.foo)}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('When the input inside the multiple select gets focused, the trigger and the dropdown gain special `--active` classes', async function(assert) {
    ...
    this.numbers = numbers;
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @onChange={{action (mut this.foo)}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('When the power select multiple uses the default component and the search is enabled, and the component receives an specific tabindex, the trigger has tabindex=-1, and the tabindex is applied to the searchbox inside', async function(assert) {
    ...
    this.numbers = numbers;
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{action (mut this.foo)}} @tabindex="3" @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('Multiple selects honor the `defaultHighlighted` option', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{action (mut this.foo)}} @defaultHighlighted={{defaultHighlighted}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('When there is an option which is disabled the css class "ember-power-select-multiple-option--disabled" should be added', async function(assert) {
    ...
    await render(hbs`
      <PowerSelectMultiple @options={{countriesWithDisabled}} @selected={{this.foo}} @onChange={{action (mut this.foo)}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
  ...
  test('The title is rendered in the trigger of multiple selects', async function (assert) {
    ...
    this.numbers = numbers;
    await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @onChange={{action (mut this.foo)}} @title="The title" as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
