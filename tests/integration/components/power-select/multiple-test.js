...
module(
  ...
  function (hooks) {
    ...
    test('If there is many selections, all those options are styled as `selected`', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.selectedNumbers}} @onChange={{action (mut this.selectedNumbers)}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
    ...
    test('The filtering specifying a searchkey works in multiple model', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @options={{this.people}} @searchField="name" @onChange={{action (mut this.foo)}} @searchEnabled={{true}} as |person|>
    ...
    test('The filtering specifying a custom matcher works in multiple model', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @matcher={{this.endsWithMatcher}} @onChange={{action (mut this.foo)}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
    ...
    test('The search using a custom action works int multiple mode', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @search={{this.searchFn}} @onChange={{action (mut this.foo)}} @searchEnabled={{true}} as |number|>
        {{number}}
      </PowerSelectMultiple>
    `);
    ...
    test('Typing in the input opens the component and filters the options also with async searches', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @selected={{this.foo}} @onChange={{action (mut this.foo)}} @search={{action this.search}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
    ...
    test('When hitting ENTER after a search with no results, the component is closed but the onchange function is not invoked', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{action this.handleChange}} @searchEnabled={{true}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
    ...
    test('Multiple selects honor the `defaultHighlighted` option', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @options={{this.numbers}} @selected={{this.foo}} @onChange={{action (mut this.foo)}} @defaultHighlighted={{this.defaultHighlighted}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
    ...
    test('When there is an option which is disabled the css class "ember-power-select-multiple-option--disabled" should be added', async function (assert) {
      ...
      await render(hbs`
      <PowerSelectMultiple @options={{this.countriesWithDisabled}} @selected={{this.foo}} @onChange={{action (mut this.foo)}} as |option|>
        {{option}}
      </PowerSelectMultiple>
    `);
      assert
